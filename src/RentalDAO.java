...
public class RentalDAO {
    ...
    public void deleteRenterFromSystemDLN(String driver_license_number) {
        ...
        for(RentalContract r : rentalContractList){
            if(r.getDriverLicenseNumber().equals(driver_license_number)){
                System.out.println("Renter has an active contract and cannot be deleted");
                return;
            }
        }
    ...
    public void deleteRenterFromSystemEmail(String email) {
        ...
        for(RentalContract r : rentalContractList){
            if(r.getRenter().getEmail().equals(email)){
                System.out.println("Renter has an active contract and cannot be deleted");
            return;
            }
        }
